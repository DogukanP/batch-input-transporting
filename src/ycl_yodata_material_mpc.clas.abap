class YCL_YODATA_MATERIAL_MPC definition
  public
...
public section.
  ...
  types:
     TS_MATERIAL type ZDOP_BAPI_EXP_MATERIAL .
  types:
...
CLASS YCL_YODATA_MATERIAL_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'YODATA_MATERIAL_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZDOP_BAPI_EXP_MATERIAL'
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20211214111455'.                  "#EC NOTEXT
