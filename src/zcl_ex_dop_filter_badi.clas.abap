class ZCL_EX_DOP_FILTER_BADI definition
  public
  final
  create public .
...
CLASS ZCL_EX_DOP_FILTER_BADI IMPLEMENTATION.
  ...
  DATA: exitintf TYPE REF TO ZIF_EX_DOP_FILTER_BADI,
    ...
    ELSE.
      ...
      IF sy-subrc ne 0.
        CALL METHOD CL_EXIT_MASTER=>CREATE_OBJ_BY_INTERFACE_FILTER
           EXPORTING
              CALLER       = me
              INTER_NAME   = 'ZIF_EX_DOP_FILTER_BADI'
              METHOD_NAME  = 'KDV_HESAPLA'
  ...
  IF <flt_cache_line>-valid = sxrt_true.
    ...
    CALL FUNCTION 'PF_ASTAT_OPEN'
       EXPORTING
           OPENKEY = '00mfGAQx7joUXzT4oJwtfm'
           TYP     = 'UE'.
        ...
        IF <flt_cache_line>-eo_object is initial.
          CALL METHOD ('CL_FOBU_METHOD_EVALUATION')=>load
               EXPORTING
                  ...
                  im_interface_name = 'ZIF_EX_DOP_FILTER_BADI'
