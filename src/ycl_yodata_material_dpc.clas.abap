class YCL_YODATA_MATERIAL_DPC definition
  public
...
protected section.
  ...
  methods MATERIALSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type YCL_YODATA_MATERIAL_MPC=>TS_MATERIAL
    raising
  ...
  methods MATERIALSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type YCL_YODATA_MATERIAL_MPC=>TT_MATERIAL
...
CLASS YCL_YODATA_MATERIAL_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 14.12.2021 14:15:10 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - YCL_YODATA_MATERIAL_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA materialset_create_entity TYPE ycl_yodata_material_mpc=>ts_material.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA materialset_get_entity TYPE ycl_yodata_material_mpc=>ts_material.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - YCL_YODATA_MATERIAL_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA materialset_get_entityset TYPE ycl_yodata_material_mpc=>tt_material.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA materialset_update_entity TYPE ycl_yodata_material_mpc=>ts_material.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
*  Data declaration
*-------------------------------------------------------------
 DATA material TYPE yif_zdop_bapi_material_data=>zdop_bapi_s_material.
 DATA material_detail TYPE yif_zdop_bapi_material_data=>zdop_bapi_exp_material.
 DATA return TYPE yif_zdop_bapi_material_data=>bapiret2.
...
* Maps key fields to function module parameters
    ...
    IF lv_source_entity_set_name = 'MATERIALSet' AND
    ...
    ENDIF.
       ...
       material-matnr = ls_converted_keys-matnr.
* Get RFC destination
...
*-------------------------------------------------------------
lv_rfc_name = 'ZDOP_BAPI_MATERIAL_DATA'.
...
* Map properties from the backend to the Gateway output response structure
     ...
     er_entity-matnr = material-matnr.
     er_entity-mbrsh = material_detail-mbrsh.
     er_entity-matkl = material_detail-matkl.
     er_entity-meins = material_detail-meins.
     er_entity-mtart = material_detail-mtart.
  endmethod.
